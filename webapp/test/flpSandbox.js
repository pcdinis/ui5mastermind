		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mastermind",
									"targetURL": "#ptdeploygameui5mastermind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ptdeploygameui5mastermind-display": {
								"semanticObject": "ptdeploygameui5mastermind",
								"action": "display",
								"description": "A UI5 Game",
								"title": "Mastermind",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pt.deploy.game.ui5mastermind",
									"url": sap.ui.require.toUrl("pt/deploy/game/ui5mastermind")
								}
							}
						}
					}
